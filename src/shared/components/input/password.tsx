...
export default function Password(props: PasswordProps) {
  ...
  return (
    <label htmlFor={props.name} className="w-full text-xl font-semibold">
      <p className="flex">
        {props.label}
      ...
      <div className="relative mt-2">
        <input
          ...
          className="w-full rounded-sm bg-gscale-400 px-8 py-3 border border-transparent focus:border-secondary-300 max-h-13"
          value={props.value ?? ""}
